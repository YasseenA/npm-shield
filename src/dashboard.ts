...
import { AuditRunner, AuditResults, Vulnerability } from './auditRunner';
...
export class DashboardPanel {
  ...
  static show(context: vscode.ExtensionContext, auditor: AuditRunner): void {
  ...
  private constructor(
    ...
    this._disposables.push(
      auditor.onResultsUpdated(results => this.update(results))
    );
  ...
  private getHtml(results: AuditResults): string {
